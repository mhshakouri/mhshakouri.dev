...
/* GitHub's mark, inlined rather than pulled from an icon package. */
function GitHubMark() {
  return (
    <svg
      viewBox="0 0 16 16"
  ...
  return (
    <footer className="border-border border-t print:hidden">
      <Container className="text-muted-foreground flex h-16 items-center justify-between text-sm">
        {/* Kept inline, not flex: a flex container collapses the whitespace
            around the middle-dot separators. */}
        <p>
